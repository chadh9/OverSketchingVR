...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean PenDrawing
        {
            get
            {
                return SteamVR_Actions.default_PenDrawing;
            }
        }
        
        public virtual SteamVR_Action_Boolean OverSketchingDrawing
        {
            get
            {
                return SteamVR_Actions.default_OverSketchingDrawing;
            }
        }
        
        public virtual SteamVR_Action_Vector2 OversketchingWeighting
        {
            get
            {
                return SteamVR_Actions.default_OversketchingWeighting;
            }
        }
        
        public virtual SteamVR_Action_Vector2 OverSketchingRange
        {
            get
            {
                return SteamVR_Actions.default_OverSketchingRange;
            }
        }
        ...
        public virtual SteamVR_Action_Boolean Tutorial
        {
            get
            {
                return SteamVR_Actions.default_Tutorial;
            }
        }
